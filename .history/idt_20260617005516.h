...
typedef void (*isr_handler_t)(registers_t*); // <-- NEW: Added for Exceptions
...
// ----- DYNAMIC ISR (NEW) -----
void isr_install_handler(int isr, isr_handler_t handler); // <-- NEW: To register Page Fault
void isr_uninstall_handler(int isr);                      // <-- NEW: To unregister if needed
...
// ----- HARDWARE IRQS 0-15 -----
extern void irq0(); extern void irq1();  // Keyboard
