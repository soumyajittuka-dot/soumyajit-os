...
#define MEM_START 0x200000 // 2MB থেকে হিপ শুরু - পেজিং এ ম্যাপড
#define MEM_SIZE 0x6400000 // 100MB
#define BLOCK_SIZE 4096 // 4KB blocks
#define BLOCK_COUNT 25600 // 100MB / 4KB

// Placement allocator - পেজিং স্ট্রাকচারের জন্য। 2MB থেকে শুরু
...
void mem_init() {
    ...
    print_string("Heap: 100MB @ 0x200000 [4KB Blocks]\n");
}
