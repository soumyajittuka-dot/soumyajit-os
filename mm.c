...
// ==== লোকাল VGA print_int ====
void print_int_vga(int n) {
    if(n == 0) {
        vga_print_string("0", VGA_COLOR_WHITE);
        return;
    }
...
void mem_stats() {
    ...
    vga_print_string("\n=== Memory Stats ===\n", VGA_COLOR_YELLOW);
    vga_print_string("Total: ", VGA_COLOR_WHITE); print_int_vga(total_kb / 1024); vga_print_string(" MB\n", VGA_COLOR_WHITE);
    vga_print_string("Used : ", VGA_COLOR_WHITE); print_int_vga(used_kb / 1024); vga_print_string(" MB (", VGA_COLOR_WHITE); print_int_vga(used_kb); vga_print_string(" KB)\n", VGA_COLOR_WHITE);
    vga_print_string("Free : ", VGA_COLOR_WHITE); print_int_vga(free_kb / 1024); vga_print_string(" MB (", VGA_COLOR_WHITE); print_int_vga(free_kb); vga_print_string(" KB)\n", VGA_COLOR_WHITE);
}
